Profile: TemperaturaCorporal
Parent: Observation
Id: TemperaturaCorporal
* ^url = "https://hl7co.org/fhir/StructureDefinition/TemperaturaCorporal"
* ^status = #draft
* identifier 0..0
* basedOn 0..0
* partOf 0..0
...
* code.coding contains
    SnomedCode 1..1 and
    LoincCode 0..1
* code.coding[SnomedCode] from http://hl7.org/fhir/ValueSet/observation-codes
* code.coding[SnomedCode].system 1..1 MS
* code.coding[SnomedCode].system = "http://snomed.info/sct" (exactly)
* code.coding[SnomedCode].version 0..0
* code.coding[SnomedCode].code 1..1 MS
* code.coding[SnomedCode].code = #386725007 (exactly)
* code.coding[SnomedCode].display 1..1 MS
* code.coding[SnomedCode].display = "Body temperature (observable entity)" (exactly)
* code.coding[SnomedCode].userSelected 0..0
* code.coding[LoincCode] from http://hl7.org/fhir/ValueSet/observation-codes
...
* referenceRange.high.value = 37.3 (exactly)
* referenceRange.high.unit 1..1
